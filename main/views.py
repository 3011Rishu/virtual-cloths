	...
	if request.method == "POST":
		...
		while True:
			...
			if lmList:
				...
				lm11 = lmList[11][1:3]
				lm12 = lmList[12][1:3]
				file_name = os.path.split(cloth.image1.url)
				main_path = file_name[1]
				imgShirt = cv2.imread('media/products/images/' + main_path, cv2.IMREAD_UNCHANGED)
				print(cloth.image1.url)
